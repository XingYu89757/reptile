...
import com.imton.reptile.demo.service.Impl.MovieDescServiceImpl;
import com.imton.reptile.demo.service.Impl.MovieUrlServiceImpl;
...
public class GetMovieDesc {
    @Autowired
     static  MovieDescService movieDescService;
    @Autowired
    static MovieUrlService movieUrlService;
    ...
    public  void testMathod() throws IOException {
       ...
       // getListDesc(url);
        ...
        movieUrlService.save(movieUrlEntity);
